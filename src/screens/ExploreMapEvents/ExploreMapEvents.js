...
<div class="absolute top-[45%] left-[45%] -translate-x-1/2 -translate-y-1/2 cursor-pointer group">
<div class="relative flex items-center justify-center w-12 h-12 bg-tertiary rounded-full ring-4 ring-white whisper-shadow transition-transform group-hover:scale-110">
<span class="material-symbols-outlined text-white text-[24px]">calendar_today</span>
<div class="absolute -top-1 -right-1 w-4 h-4 bg-error rounded-full border-2 border-white"></div>
</div>
</div></div>
</div>
...
</header><div class="fixed top-24 left-1/2 -translate-x-1/2 z-40">
<button class="flex items-center gap-2 px-4 py-2 bg-surface-pure rounded-full whisper-shadow border border-soft-border/20 transition-transform active:scale-95">
<span class="material-symbols-outlined text-primary text-[20px]">local_activity</span>
<span class="font-body-md text-[14px] font-bold text-on-surface">Events</span>
</button>
</div>
...
<div class="fixed bottom-48 left-0 right-0 z-40 px-margin-page pointer-events-none">
<div class="max-w-md mx-auto pointer-events-auto">
<div class="glass-panel p-4 rounded-2xl whisper-shadow border border-white/50 flex flex-col gap-3">
<div class="flex justify-between items-start">
<div>
<span class="font-technical-label text-[10px] text-tertiary uppercase tracking-widest">Featured Event</span>
<h2 class="font-headline-md text-[18px] text-on-surface">Urban Photo Walk</h2>
</div>
...
<span class="font-body-md text-[12px]">Sat, 2:00 PM</span>
</div>
<div class="flex items-center gap-1">
<span class="material-symbols-outlined text-[18px]">near_me</span>
<span class="font-body-md text-[12px]">0.5km away</span>
</div>
</div>
<button class="w-full py-3 bg-primary text-white rounded-xl font-bold text-[14px] transition-transform active:scale-[0.98]">
        View Details
      </button>
</div>
</div>
</div><div class="fixed bottom-0 left-0 right-0 z-30 transition-transform duration-500 ease-[cubic-bezier(0.2,0,0,1)]" id="bottom-sheet" style="transform: translateY(calc(100% - 180px));">
...
export default function ExploreMapEvents() {
  return (
